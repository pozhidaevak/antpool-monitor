...
public final class Messages {
  ...
  static public String workerLowHashRate(String workerName, double currentHashRate, double thresholdHashRate) {
    return getMessage("workerLowHashRate", new Object[] {workerName, currentHashRate, thresholdHashRate});
  }
